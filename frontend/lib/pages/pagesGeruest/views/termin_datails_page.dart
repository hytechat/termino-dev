...
class TerminDetailsPage extends StatefulWidget {
// const TerminDetailsPage({Key? key}) : super(key: key);
  ...
  @override
  _TerminDetailsPage createState() =>
      _TerminDetailsPage(organizer, titel, place, options);
}

class _TerminDetailsPage extends State<TerminDetailsPage> {
